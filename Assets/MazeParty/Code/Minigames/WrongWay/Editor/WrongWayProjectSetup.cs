...
namespace MazeParty.Editor
{
    ...
    public static class WrongWayProjectSetup
    {
        ...
        private const string ScenesFolder =
            "Assets/MazeParty/Scenes/Minigames/WrongWay";
        private const string UiFolder =
            "Assets/MazeParty/Prefabs/Minigames/WrongWay";
            ...
            Material finishMaterial)
        {
            ...
            var connectedLane = MinigameCorePrefabUtility.Connect(
                lane,
                CorePrefabFolder + "/Lane" + (slot + 1) + ".prefab");
            connectedLane.name = "Lane " + (slot + 1);
        }
            ...
            Material material)
        {
            ...
            MinigameCorePrefabUtility.Connect(
                finishRoot,
                CorePrefabFolder + "/FinishArch.prefab");
        }
