...
namespace MazeParty.Editor
{
    ...
    public static class CliffBarrageProjectSetup
    {
        ...
        private const string SceneFolder = "Assets/MazeParty/Scenes/Minigames/CliffBarrage";
        ...
        private static void BuildScene(Materials materials)
        {
            ...
            try
            {
                ...
                var structure = new GameObject("Cliff Arena");
                structure.transform.SetParent(arena.transform, false);
                CreateCliff(structure.transform, materials);
                MinigameCorePrefabUtility.Connect(structure,
                    CorePrefabFolder + "/CliffArena.prefab");
            ...
            Transform parent, Materials materials)
        {
            ...
            for (var index = 0; index < count; index++)
            {
                ...
                result.WarningBeams[index] = warningBeam;
                result.FiringBeams[index] = firingBeam;
            }
