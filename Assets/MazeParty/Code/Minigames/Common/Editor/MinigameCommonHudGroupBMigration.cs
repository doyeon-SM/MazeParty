...
namespace MazeParty.Editor
{
    ...
    public static class MinigameCommonHudGroupBMigration
    {
        ...
        private const string UiFolder = "Assets/MazeParty/Prefabs/Minigames/Common/UI/";
        ...
        {
            EditPrefab("Assets/MazeParty/Prefabs/Minigames/TerritoryPaint/UI/TerritoryPaintHud.prefab", root =>
            {
        ...
        {
            EditPrefab("Assets/MazeParty/Prefabs/Minigames/SequenceMemory/UI/SequenceMemoryHud.prefab", root =>
            {
        ...
        {
            EditPrefab("Assets/MazeParty/Prefabs/Minigames/BouncingBalls/UI/BouncingBallsHud.prefab", root =>
            {
                var hudRoot = root.transform.Find("HUD Root");
                if (hudRoot == null)
                {
