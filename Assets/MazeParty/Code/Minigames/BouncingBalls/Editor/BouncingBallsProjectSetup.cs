...
namespace MazeParty.Editor
{
    ...
    public static class BouncingBallsProjectSetup
    {
        ...
        private const string SceneFolder = "Assets/MazeParty/Scenes/Minigames/BouncingBalls";
        ...
        private static ArenaReferences CreateArena(Transform parent, Materials materials)
        {
            ...
            for (var slot = 0; slot < PlayerCount; slot++)
            {
                ...
                var goal = CreatePrimitive("Goal " + (slot + 1), PrimitiveType.Cube,
                ...
                MinigameCorePrefabUtility.Connect(goal,
