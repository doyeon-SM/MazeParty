...
namespace MazeParty.Editor
{
    ...
    public static class SequenceMemoryProjectSetup
    {
        ...
        private const string MinigameScenesFolder =
            ScenesFolder + "/Minigames";
        private const string UiPrefabFolder = ProjectRoot + "/UI/Prefabs";
        private const string MaterialFolder =
            ProjectRoot + "/Art/Minigames/SequenceMemory/Materials";
        private const string RaceScenePath = ScenesFolder + "/Race.unity";

        public const string ScenePath =
            MinigameScenesFolder + "/SequenceMemory.unity";
        public const string HudPrefabPath =
            UiPrefabFolder + "/SequenceMemoryHud.prefab";
